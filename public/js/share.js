function share(user){
    let html =`
      ...
      <ul class="nav nav-pills nav-stack small fw-normal">
        ...
        <li class="nav-item">
          <a class="disabled nav-link bg-light py-1 px-2 mb-0" href="#!" data-bs-toggle="modal" data-bs-target="#editPost"> <i class="bi bi-image-fill text-success pe-2"></i>Photo</a>
        </li>

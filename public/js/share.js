function share(user){
    let html =`
      ...
      <div class="d-flex mb-3">
        ...
        <form class="w-100">
          <input class="form-control pe-4 border-0" placeholder="Share your thoughts..." data-bs-toggle="modal" data-bs-target="#modalAddPost">
        </form>
      </div>
      ...
      <ul class="nav nav-pills nav-stack small fw-normal">
        ...
        <li class="nav-item">
          <a class="nav-link bg-light py-1 px-2 mb-0" href="#!" data-bs-toggle="modal" data-bs-target="#photoModal"> 
